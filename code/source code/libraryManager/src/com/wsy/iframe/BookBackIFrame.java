...
public class BookBackIFrame extends JInternalFrame {
	...
	private String[] columnNames = { "BookName", "ISBN","BookType","ReaderName","Reader BarCode","Borrowing Time","Due Time"};
	...
	public BookBackIFrame() {
		...
		setIconifiable(true);							
		setClosable(true);								
		setTitle("Book returning management");
		setBounds(100, 100, 600, 480);

		final JPanel panel = new JPanel();
		panel.setBorder(new TitledBorder(null, "Basic info.", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
		...
		panel_2.setBorder(new TitledBorder(null, "Fine.info", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
		panel_2.setPreferredSize(new Dimension(250, 230));
		panel_1.add(panel_2);

		final JLabel label_11 = new JLabel();
		label_11.setText("Borrowing date：");
		...
		panel_3.setBorder(new TitledBorder(null, "System info.", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
		...
		label_10_1.setText("Current time：");
		...
		buttonback.setText("Returning book");
	...
	class TableListener extends MouseAdapter {
		public void mouseClicked(final MouseEvent e) {
			...
			if(days3>0){
				...
				fkmoney.setText(zfk+"Yen");
			}
			else{
				ccdays.setText("U are a good boy");
				fkmoney.setText("0");
			}
	...
	class BookBackActionListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			// TODO 自动生成方法存根
			if(readerISBNs==null){
				JOptionPane.showMessageDialog(null, "Please input the reader No.！");
				return;
			}
			System.out.println(bookISBNs==null);

			if(table.getSelectedRow()==-1){
				JOptionPane.showMessageDialog(null, "Please choose the borrowing book！");
				return;	
			}
