...
public class BookLoginIFrame extends JFrame {
	...
	public BookLoginIFrame() {
		...
		panel_2.add(label);
		label.setText("Username£º");

		username = new JTextField(20);
		username.setPreferredSize(new Dimension(0, 0));
		username.setSize(200, 200);
//		username.setHorizontalAlignment(SwingConstants.CENTER);
		...
		ImageIcon loginIcon=CreatecdIcon.add("LMB_lib1.jpg");
		tupianLabel.setIcon(loginIcon);
		tupianLabel.setOpaque(true);
		tupianLabel.setBackground(Color.RED);
		tupianLabel.setPreferredSize(new Dimension(200, 60));
