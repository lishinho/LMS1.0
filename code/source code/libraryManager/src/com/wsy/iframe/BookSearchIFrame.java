...
public class BookSearchIFrame extends JInternalFrame {
	 ...
	 * Create the frame
	 */
	String booksearch[] = { "ISBN", "Type", "Name", "Author", "Translator","Press",  "PublishDate", "Price" };
	...
	public BookSearchIFrame() {
		...
		tabbedPane.addTab("Inquire", null, panel_1, null);

		final JPanel panel_1_1 = new JPanel();
		panel_1_1.setBorder(new TitledBorder(null, "Please Choose the reserach item", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
		panel_1_1.setPreferredSize(new Dimension(0, 50));
		panel_1.add(panel_1_1, BorderLayout.NORTH);
         choice=new JComboBox();
		String[] array={"BookName","Author"};
		...
		panel.setBorder(new TitledBorder(null, "Result Display", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
		panel_1.add(panel);
		...
		tabbedPane.addTab("Display all", null, panel_2, null);
