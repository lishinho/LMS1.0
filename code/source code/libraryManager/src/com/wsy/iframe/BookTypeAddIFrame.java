...
public class BookTypeAddIFrame extends JInternalFrame {
	...
	public BookTypeAddIFrame() {
		super();
		setIconifiable(true);							// Window Min
		setClosable(true);
		setTitle("Add Booktype");
		setBounds(100, 100, 500, 428);
		...
		ImageIcon bookTypeAddIcon=CreatecdIcon.add("LMS_BookTypeAdd.jpg");
		label_4.setIcon(bookTypeAddIcon);
		label_4.setPreferredSize(new Dimension(400, 80));
		label_4.setText("Pic£¨400*80£©");
		panel.add(label_4);
		...
		label_2.setText("Booktype Name£º");
		panel_3.add(label_2);
		...
		label_3.setText(" Useable Days£º");
		panel_3.add(label_3);
		...
		label_5.setText("Fine£¨in a day£©£º");
		panel_3.add(label_5);

		fakuan = new JTextField("per En");
		...
		button.addActionListener(new ActionListener(){
			public void actionPerformed(final ActionEvent e) {
				...
				if(fakuan.getText().length()==0||fakuan.getText().trim().equals("per En")){
					JOptionPane.showMessageDialog(null, "Cannot be null");
					return;
				}
