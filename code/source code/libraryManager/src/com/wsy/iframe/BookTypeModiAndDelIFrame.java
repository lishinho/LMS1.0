...
public class BookTypeModiAndDelIFrame extends JInternalFrame {
	...
	private String[] columnNames={ "BookType No.", "BookType Name", "Usable Days","Fine"};
	...
	public BookTypeModiAndDelIFrame() {
		...
		ImageIcon bookTypeModiAndDelIcon=CreatecdIcon.add("LMS_ModiBookType.jpg");
