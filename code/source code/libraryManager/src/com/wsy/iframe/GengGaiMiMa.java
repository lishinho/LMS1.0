...
public class GengGaiMiMa extends JInternalFrame{
	...
	public GengGaiMiMa() {
		...
		label_4.setText("<html>Note: Each <b> Operator </b>can only change his own password.</html>");
...
//		gridBagConstraints_12.weighty = 1.0;
		...
		label_1.setText("Old Password£º");
		...
		label_2.setText("New Password£º");
		...
		label_3.setText("Vertify the password£º");
			...
			public void actionPerformed(final ActionEvent e) {
				if (oldPass.getText().equals(user.getPassword())) {
					if (newPass1.getText().equals(newPass2.getText())) {
						...
						JOptionPane.showMessageDialog(getContentPane(), "New password is not the same. Please input once again");
					}
				}else {
					JOptionPane.showMessageDialog(getContentPane(), "Old password is wrong, please vertify.");
				}
			}
		});
		button.setText("Vertify");
