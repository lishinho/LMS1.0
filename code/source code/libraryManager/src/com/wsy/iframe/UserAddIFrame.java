...
public class UserAddIFrame extends JInternalFrame {
	...
	public UserAddIFrame() {
		...
		setIconifiable(true);
		setClosable(true);
		setTitle("Add userinfo.");
		setBounds(120, 120, 600, 420);
			...
			public void actionPerformed(ActionEvent arg0) {
				if(arg0.getSource()==button){
					...
					if(textField.getText().length()>12){
						JOptionPane.showMessageDialog(null, "Username is up to 12bits. ");
						return;
					}
					...
					if(textField_6.getText().length()>15){
						JOptionPane.showMessageDialog(null, "Password is up tp 15dits.");
						return;
					}
