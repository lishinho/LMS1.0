...
public class UserModiAndDelIFrame extends JInternalFrame {
	...
	private Object[][] getFileStates(List list){
		String[] str = { "UserNo.", "UserName", "Sexual", "Age", "IDcard", "CreatedDate",
				"Tel", "Password" };
	...
	public UserModiAndDelIFrame() {
		...
		setIconifiable(true);
		setClosable(true);
		setTitle("User info. modify or delete");
		...
		str = new String[]{"UserNo.", "UserName", "Sexual", "Age", "IDcard", "CreatedDate",
				"Tel", "Password" };
		...
		table.addMouseListener(new MouseAdapter() {
			public void mouseClicked(final MouseEvent e) {
				...
				if(table.getValueAt(selRow, 2).toString().trim().equals("Male"))
		...
		textField_4 = new JTextField("Tel number is 11dits.",11);
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(textField.getText().length()==0){
					...
					if(textField_4.getText().length()!=11){
						JOptionPane.showMessageDialog(null, "Tel number is 11 dits.");
						return;
					}
					if(textField_5.getText().length()==0){
						JOptionPane.showMessageDialog(null, "ID card cannot be null.");
						return;
					}
					...
					if(textField_6.getText().length()>15){
						JOptionPane.showMessageDialog(null, "Password is up to 15dits.");
						return;
					}
